...
function wp_boilerplate_setup() {
    ...
    register_nav_menus( array(
        'primary' => esc_html__( 'Primary', 'wp-boilerplate' ),
    ) );
...
function wp_boilerplate_scripts() {
    ...
    wp_enqueue_style( 'bootstrap-css', get_template_directory_uri() . '/css/vendor/bootstrap.css', array(), '3.3.7', 'all' );

    wp_register_script( 'bootstrap-js', get_template_directory_uri() . '/js/vendor/bootstrap.js', array( 'jquery' ), '3.3.7', true );

    wp_enqueue_script( 'wp-boilerplate-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

    wp_enqueue_script( 'wp-boilerplate-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
