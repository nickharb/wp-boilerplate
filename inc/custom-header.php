...
function wp_boilerplate_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'wp_boilerplate_custom_header_args', array(
		'default-image'          => '',
 ...
 *
 * @see wp_boilerplate_custom_header_setup().
 */
function wp_boilerplate_header_style() {
